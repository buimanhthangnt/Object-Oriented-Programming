...
//        assertTrue(horizontalStick.equals(stick.computeNextRotation()));
//    }
//
//    @Test
...
//        assertTrue(pieces[Piece.SQUARE] == pieces[Piece.SQUARE].fastRotation());
//        assertTrue(pieces[Piece.SQUARE] == pieces[Piece.SQUARE].fastRotation().fastRotation());
//        //....
//    }
//
//    @Test
...
//        assertEquals(L, Piece.getPieces()[Piece.L1].fastRotation().fastRotation().fastRotation().fastRotation());
//    }
//}